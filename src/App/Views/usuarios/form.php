...
<?php if (isset($message)): ?>
  <div class="toast position-absolute top-0 start-50 translate-middle-x show border border-light mt-4" role="alert" aria-live="assertive" aria-atomic="false">
    <div class="toast-header">
      <strong class="me-auto">Mensaje de registro</strong>
...
<main class="container-fluid">
  <div class="row align-items-center justify-content-center" style="min-height: 100vh">
    <div class="col-12 col-sm-10 col-lg-5">
      ...
      <form method="POST" class="needs-validation row g-3" action="<?= route('usuarios') ?>" novalidate>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <input type="text" name="apellido_paterno" id="apellido_paterno" class="form-control" autocomplete="off" required>
          <div class="invalid-feedback">
            <small><small>Debe completar este campo</small></small>
          </div>
        </div>
        <div class="col-md-6">
          ...
          <input type="text" name="apellido_materno" id="apellido_materno" class="form-control" autocomplete="off" required>
          <div class="invalid-feedback">
            <small><small>Debe completar este campo</small></small>
          </div>
        </div>
        <div class="col-md-6">
          ...
          <input type="text" name="nombre_de_usuario" id="nombre_de_usuario" class="form-control" autocomplete="off" required>
          <div class="invalid-feedback">
            <small><small>Debe completar este campo</small></small>
          </div>
        </div>
        ...
        <div class="col-md-6">
          ...
          <input type="password" name="contraseña" id="contraseña" class="form-control" autocomplete="off" required>
          <div class="invalid-feedback">
            <small><small>Debe completar este campo</small></small>
          </div>
        </div>
